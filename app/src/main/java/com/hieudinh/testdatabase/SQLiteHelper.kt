...
class SQLiteHelper  (context: Context) : SQLiteOpenHelper(context,DATABASE_NAME,null,DATABASE_VERSION) {
    ...
    companion object{
        ...
        private const val DATABASE_NAME ="studentSS.db"
        private const val DATABASE_VERSION=1
        private const val ID="id"
        private  const val NAME ="name"
        private const val EMAIL = "email"
        private const val CLASSS = "classs"
        private const val CLASSS2 = "classs2"

        private  const val TBL_STUDENT="tbl_studentS"
    }
    override fun onCreate(p0: SQLiteDatabase?) {
        val  createTbStudent=("CREATE TABLE "+ TBL_STUDENT+" ("+ ID+" INTEGER PRIMARY KEY ,"
                + NAME + " TEXT, " + EMAIL +" TEXT ," + CLASSS +" TEXT , " + CLASSS2 + "  TEXT )" )
    ...
    fun insertStudent(std : StudentModel) : Long{
        ...
        contentValues.put(CLASSS2,std.classs2)
    ...
    fun getAllStudent() : ArrayList<StudentModel>{
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                classs2 = cursor.getString(cursor.getColumnIndex("classs2"))



                val std =StudentModel(id=id,name=name,email= email ,classs=classs ,classs2=classs2)
                stdlist.add(std)
    ...
    fun  updateStudent(std : StudentModel) : Int{
        ...
        caontentValues.put(CLASSS2,std.classs2)
